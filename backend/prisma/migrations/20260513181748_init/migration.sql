-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('CUSTOMER', 'VENDOR_OWNER', 'VENDOR_MANAGER', 'PLATFORM_ADMIN', 'GOD_USER');

-- CreateEnum
CREATE TYPE "ArtistType" AS ENUM ('BAND', 'COMEDIAN', 'INFLUENCER', 'ARTIST', 'OTHER');

-- CreateEnum
CREATE TYPE "TenantStatus" AS ENUM ('PENDING', 'ACTIVE', 'FROZEN', 'REJECTED');

-- CreateEnum
CREATE TYPE "ProductStatus" AS ENUM ('DRAFT', 'PENDING_REVIEW', 'LIVE', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PLACED', 'CONFIRMED', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "ShipmentStatus" AS ENUM ('CREATED', 'IN_TRANSIT', 'DELIVERED', 'FAILED');
...
CREATE TABLE "Tenant" (
    ...
    "artistType" "ArtistType" NOT NULL DEFAULT 'OTHER',
...
-- CreateIndex
CREATE UNIQUE INDEX "Follow_userId_tenantId_key" ON "Follow"("userId", "tenantId");
